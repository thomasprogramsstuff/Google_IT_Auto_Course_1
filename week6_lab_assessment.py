...
#<ipython-input-12-090ab59a33cd> in <module>
#      2 server.add_connection("192.168.1.1")
#      3 
#----> 4 print(server.load())
#      5 
#
#<ipython-input-11-54ab5f531f68> in load(self)
#     18     def load(self):
#     19         """Calculates the current load for all connections."""
#---> 20         total = self.connection_load
#     21         # Add up the load for each of the connections
#     22         return total

#AttributeError: 'Server' object has no attribute 'connection_load'
